            ...
            while True:
                ...
                if double_down == "Y":
                    ...
                    if bet > money:
                        ...
                        playable_deck.append(dealer_choice)
                        playable_deck.append(player_choice)
                        break
                    ...
                    if player < 21 and dealer > player and dealer < 21:
                        money -= bet

                    if player < 21 and player > dealer and dealer < 21:
                        money += bet
                    break
                while player < 21:
